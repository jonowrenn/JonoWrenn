...
| [💬 CS Study Assistant](https://github.com/jonowrenn/GPTChatbot) | Multi-turn chatbot with 6 expert modes (Code Review, ML Theory, Interview Prep, etc.), deployed on Hugging Face Spaces | Python, Gradio, GPT-4o mini |
